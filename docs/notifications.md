...
| `EMAIL_PAYMENT_REMINDER`          | nezaplacená/částečně zaplacená přihláška po splatnosti  | účastník / zákonný zástupce           | podle nastavení oddílu      | opakovaně; četnost per oddíl (README → Nastavení oddílu)       | [README.md](../README.md#L325)                                                         |
| `EMAIL_PAYMENT_CONFIRMATION`      | `payment.allocated` (i částečná alokace)                | účastník / zákonný zástupce           | ihned po napárování         | jednou na alokaci — eviduje se, aby se neposílalo dvakrát      | [README.md](../README.md#L367)                                                         |
...
| Kód                             | Událost (spouštěč)                                                               | Příjemce                        | Načasování                  | Opakování / poznámka                                                                    | Zdroj                                      |
| ------------------------------- | -------------------------------------------------------------------------------- | ------------------------------- | --------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------ |
| `EMAIL_PAYMENT_REMINDER`        | nezaplacená přihláška po splatnosti (job)                                        | účastník / zákonný zástupce     | podle nastavení oddílu      | **jen u účtu s bankovním API** (`provider = 'fio'`); u ruční evidence se neposílá vůbec | [payment-matching.md](payment-matching.md) |
