...
| `document.approved` / `rejected`                     | HVO nebo VO s `can_edit_registrations`; RÁD dokumenty neposuzuje ani s tímto příznakem | přihláška patří akci, na niž má aktér přiřazení                                                                  | záznam kdo/kdy/komentář, při zamítnutí e-mail, `evaluate`                                                                                                                                     |
...
| `substitute.offer.declined`                          | náhradník                                                                              | nabídka platná                                                                                                   | nabídka přejde do `declined`, **přihláška zůstává náhradníkem v `New`**, notifikace vedoucímu a možnost vybrat dalšího náhradníka                                                             |
...
- **Uvolnění kapacity** (storno, expirace) spouští výběr náhradníka; nabídka je časově omezená a její odmítnutí ani propadnutí nemění stav přihlášky náhradníka. Odmítnutí nabídku ukončí okamžitě, aby vedoucí mohl vybrat dalšího náhradníka bez čekání na expiraci.
